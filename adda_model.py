...
#Command to Run
#python adda_model.py --target_weights /home/charan/target_rcnn/VGGnet_fast_rcnn_iter_70000.ckpt  --source_weights /home/charan/source_rcnn/VGGnet_fast_rcnn_iter_1000.ckpt --iters 5
...
class SolverWrapper(object):
	...
	snapshot_path = self.target_restorer.save(sess, os.path.join(output_dir, filename))
		...
		self.source_network.data: source_blobs['data'], self.source_network.im_info: source_blobs['im_info'], self.source_network.keep_prob: 0.5, self.source_network.gt_boxes: source_blobs['gt_boxes']}
